...
<div class="bg-custom_gray pt-2 min-vh-100">
    <div class="container d-flex align-items-start bg-light-gray rounded" style="gap:20px;">
            ...
            <div class="d-flex justify-content-between align-items-center p-2 rounded border border-success bg-success bg-opacity-10 mb-3">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="mb-0 text-success">Congratulations! You saved <strong>₹600<?//= number_format($discountAmount, 2) ?></strong>.</p>
                    </div>
                </div>
                ...
                <div class="text-end">
                    ...
                    <div class="fw-bold fs-4 text-success">₹2546<?//= number_format($finalPrice, 2) ?></div>
                </div>
            </div>
                            ...
                            <div class="row align-items-center justify-content-around px-3 py-0 border-bottom">
                                ...
                                <div class="col-md-9">
                                    <div class="d-flex justify-content-between text-center align-items-center">
                                        <?php
                                        if ($request['details'][0]['trip_type'] == 'o' && $request['details'][0]['is_return'] == true) {
                        ...
                        <div class="card shadow-sm border-0 rounded">
                            <div class="card-body p-3">
                                ...
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="checkbox" value="carrier" id="luggageSpace">
                                ...
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="checkbox" value="carModel" id="carModel">
                                ...
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="checkbox" value="driverLanguage" id="driverLanguage">
                                ...
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="checkbox" value="petAllowed" id="petAllowed">
                                ...
                                <div class="form-check mb-0">
                                    <input class="form-check-input" type="checkbox" value="refundable" id="refundableBooking">
                    ...
                    <div class="col-md-12 mb-3 p-0">
                        <div class="card shadow-sm border-0 rounded">
                            <div class="card-body p-3">
                                ...
                                <!-- Pickup Details -->
                                <div class="mb-3">
                                    <label class="fw-semibold small text-muted">Pickup Details</label>
                                    <input type="text" class="form-control contactDetails" id="pickupLocation" placeholder="Enter Pickup Location">
                                </div>

                                <!-- Traveller Contact Details -->
                                <label class="fw-semibold small text-muted">Traveller Contact Details</label>
                                <div class="row mb-3">
                                    <div class="col-md-8 mb-2 ">
                                        <input type="text" class="form-control contactDetails" id="travellerName" placeholder="Full Name">
                                    </div>
                                    <div class="col-md-4 mb-2 pl-0 ">
                                        <select class="form-control contactDetails" id="travellerGender">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-2 mb-2 ">
                                        <select class="form-control contactDetails" id="countryCode">
                                    ...
                                    <div class="col-md-5 mb-2 pl-0">
                                        <input type="tel" class="form-control contactDetails" id="travellerPhone" placeholder="Mobile No.">
                                    </div>
                                    <div class="col-md-5 mb-2 pl-0 ">
                                        <input type="email" class="form-control contactDetails" id="travellerEmail" placeholder="Email ID">
                                    </div>
                                </div>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="billingAddress" checked>
        ...
        <div class="col-md-4 mt-3 sticky-top price_card">
            ...
            $originalPrice = ceil($selectedCabResult['price']);
            ...
            $discountPercent = ($originalPrice > 0 && $discountPrice < $originalPrice) ? round((($originalPrice - $discountPrice) / $originalPrice) * 100) : 0;
            ...
            <div class="card shadow-sm border-0 rounded p-3">
                        ...
                        <label class="list-group-item d-flex justify-content-between align-items-start mb-2 border-bottom  px-0 py-1">
                            <div class="px-2 py-1 d-flex align-items-center gap-3">
                                ...
                                <label class="custom-radio me-2">
                                    <input type="radio" name="paymentOption" id="partPay">
                    ...
                    <div class="list-group list-group-flush mb-0">
                        ...
                        <label class="list-group-item d-flex justify-content-between align-items-start mb-2 border-bottom px-0 py-1">
                            <div class="px-2 py-1 d-flex align-items-center gap-3">
                                <!-- Custom radio -->
                                <label class="custom-radio me-2">
                                    <input type="radio" name="paymentOption" id="withoutService">
                                    <span class="checkmark"></span>
                                </label>
                                <div>
                    ...
                    <div class="list-group list-group-flush mb-0">
                        ...
                        <label class="list-group-item d-flex justify-content-between align-items-start mb-2 border-bottom px-0 py-1">
                            <div class="px-2 py-1 d-flex align-items-center gap-3">
                                <!-- Custom radio -->
                                <label class="custom-radio me-2">
                                    <input type="radio" name="paymentOption" id="fullPay" checked>
                                    <span class="checkmark"></span>
                                </label>
                                <div>
                ...
                <!-- Fare Breakup -->
                <a href="#" class="small fw-semibold text-primary d-block mt-2 text-decoration-none">
                    View Fare Break up <span class="material-symbols-outlined align-middle fs-6">expand_more</span>
                </a>
            </div>
