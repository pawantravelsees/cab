<div class="bg-white d-block">
                ...
                <div class="container-fluid px-0">
                    ...
                    <div class="row no-gutters">
                        <div class="col pr-1 text-center">
                            <div class="h-100 border p-2 rounded-5">
                                <img src="./img/visa-icon.svg" class="img-fluid w-auto h-custom" alt="">
                            </div>
                        </div>
                        <div class="col px-1 text-center">
                            <div class="h-100 border p-2 rounded-5">
                                <img src="./img/paytm-icon.svg" class="img-fluid w-auto h-custom" alt="">
                            </div>
                        </div>
                        <div class="col px-1 text-center">
                            <div class="h-100 border p-2 rounded-5">
                                <img src="./img/phonepe.svg" class="img-fluid w-auto h-custom" alt="">
                            </div>
                        </div>
                        <div class="col px-1 text-center">
                            <div class="h-100 border p-2 rounded-5">
                                <img src="./img/bhim-app-icon.svg" class="img-fluid w-auto h-custom" alt="">
                            </div>
                        </div>
                        <div class="col pl-1 text-center">
                            <div class="h-100 border p-2 rounded-5">
                                <img src="./img/american-express.svg" class="img-fluid w-auto h-custom" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="row no-gutters mt-2">
                        <div class="col-3 pr-1 text-center">
                            <div class="h-100 border p-2 rounded-5">
                                <img src="./img/master-card-icon.svg" class="img-fluid w-auto h-custom" alt="">
                            </div>
                        </div>
                        <div class="col-2 px-1 text-center">
                            <div class="h-100 border p-2 rounded-5">
                                <img src="./img/google-pay-acceptance-mark-icon.svg" class="img-fluid w-auto h-custom" alt="">
                            </div>
                        </div>
                        <div class="col-3 px-1 text-center">
                            <div class="h-100 border p-2 rounded-5">
                                <img src="./img/mobikwik-logo.svg" class="img-fluid w-auto h-custom" alt="">
                            </div>
                        </div>
                        <div class="col-3 px-1 text-center">
                            <div class="h-100 border p-2 rounded-5">
                                <img src="./img/rupay-logo-icon.svg" class="img-fluid w-auto h-custom" alt="">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="text-center">
        <p class="m-0 pb-3">© 2025 Travelsees. All Rights Reserved.</p>
    </div>
</div>
...
?>
<?php
if ($pagename == 'cab_details.php') {
    // <script src="./js/payment.php"></script>
    require_once($_SERVER['DOCUMENT_ROOT'] . "/cab/js/payment_script.php");
}
?>